...
def test_removing_a_photo_takes_it_out_and_keeps_it_out(tmp_path):
    """Unassigning alone would not hold: the next pass re-clusters the same
    embedding straight back in. The cannot-link is what makes it stick."""
    db_path = _archive(tmp_path)
