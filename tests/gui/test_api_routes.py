...
API_POST_CASES = [
    ...
    pytest.param(
        "/api/dups/keep",
        lambda ids: {"group_id": ids["dup_group"], "file_ids": [ids["dup_kept"], ids["dup_copy"]]},
        {"ok", "kept"},
        id="POST /api/dups/keep",
    ),
    pytest.param(
        "/api/faces/name-face",
    ...
    pytest.param(
        "/api/pet/hide",
        lambda ids: {"pet_id": ids["pet_a"], "reason": "unknown"},
        {"ok"},
        id="POST /api/pet/hide (unknown)",
    ),
    pytest.param(
        "/api/pet/unhide",
        lambda ids: {"pet_id": ids["pet_a"]},
        {"ok"},
        id="POST /api/pet/unhide",
    ),
    pytest.param(
        "/api/pet/rename",
