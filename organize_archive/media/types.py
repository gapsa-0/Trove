...
IMAGE_EXTS = {
    ...
    "heic", "heif", "jfif", "raw", "cr2", "nef", "arw", "dng",
}
VIDEO_EXTS = {
    "mp4", "mov", "avi", "wmv", "mkv", "3gp", "3g2", "m4v", "mpg",
    "mpeg", "flv", "webm", "mts", "m2ts", "swf",
}
AUDIO_EXTS = {
    "opus", "mp3", "m4a", "aac", "wav", "flac", "ogg", "amr", "wma",
}
DOCUMENT_EXTS = {
    "pdf", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "odt", "ods",
    "odp", "txt", "csv", "html", "rtf", "ipynb", "md", "mhtml",
}
