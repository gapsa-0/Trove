...
| --- | --- | --- |
| Windows 10/11 (64-bit) | [Trove.Setup.0.3.1.exe](https://github.com/gapsa-0/Trove/releases/download/v0.3.1/Trove.Setup.0.3.1.exe) | 264 MB |
| Linux, any distribution | [Trove-0.3.1.AppImage](https://github.com/gapsa-0/Trove/releases/download/v0.3.1/Trove-0.3.1.AppImage) | 382 MB |
| Debian / Ubuntu | [trove-desktop_0.3.1_amd64.deb](https://github.com/gapsa-0/Trove/releases/download/v0.3.1/trove-desktop_0.3.1_amd64.deb) | 260 MB |
...
[SHA256SUMS.txt](https://github.com/gapsa-0/Trove/releases/download/v0.3.1/SHA256SUMS.txt).
